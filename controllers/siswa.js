    ...
    index: async (req, res) => {
        try {
            ...
            if(siswas.length > 0){
                ...
                res.json({
                    status: false,
                    message: "Yah datanya masih kosong :("
                })
            }
      ...
      show: async (req, res) => {
        try {
           ...
           res.json({
            ...
            method: req.method,
            url: req.url,
            message: "Okay! Data berhasil didapat!"
        })
      ...
      store: async (req, res) => {
        try {
            ...
            res.status(200).json({
                ...
                method: req.method,
                url: req.url,
                message: "Okay! Data berhasil ditambahkan!"
            })
      ...
      update: async (req, res) => {
        try {
           ...
           res.json({
            ...
            method: req.method,
            url: req.url,
            message: "Okay! Data berhasil diubah!"
        })
       ...
       delete: async (req, res) => {
        try {
            ...
            res.json({
                ...
                method: req.method,
                url: req.url,
                message: "Okay! Data berhasil dihapus!"
            })
        } catch (error) {
            res.status(400).json({success: false})  
        } 
